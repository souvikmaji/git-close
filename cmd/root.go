...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.git-close.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".git-close" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".git-close")
	}
